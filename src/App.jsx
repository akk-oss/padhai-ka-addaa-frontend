  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/course/:id/curriculum" element={<CourseCurriculum />} />

        <Route path="/course/:id/lessons" element={<LessonPlayer />} />
        ...
        />
        <Route path="/ai-doubt-solver" element={<DoubtSolver />} />
      </Routes>
    </BrowserRouter>
  );
}
