  ...
  return (
    <div className="about-container">
      ...
      <div className="about-section">
        ...
        <p>
          PadhAI Ka Addaa is an online learning platform designed to provide
          quality education for students across India. Our mission is to make
          learning simple, affordable, and accessible for everyone.
        </p>
      ...
      <div className="about-section">
        ...
        <p>
          ...
          platforms by helping millions of students improve their knowledge
